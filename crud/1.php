...
<head>
  ...
  <title>E-Notes - Electronic Notes Taking Application</title>
...
<?php require '_nav.php' ?>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/crud/1.php" method="POST">
  ...
  <script>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/crud/1.php?delete=${sno}`;
    ...
    <div class="image-container">
        <img class="footer-image" src="22.svg" alt="Footer Image">
</div>
<style>
    .image-container {
  display: flex;
  ...
  height: 30vh; /* Set the height of the container to the viewport height */
